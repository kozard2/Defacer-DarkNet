...
echo $yellow
figlet -f future "Indonesian Dark Net"
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo
...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"Mr.Venom"$cyan" ~/IndoDarkNet"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo
echo
echo $red "Eksekusi Target!!!"
echo $green "╭─"$blue"Mr.Venom"$cyan" ~/IndoDarkNet"$white
read -p " ╰─$ "  target
echo
echo $red "Masukan Script Cukk!!! "
echo $green "╭─"$blue"Mr.venom"$cyan" ~/Nama SC Harus(index.html)"$white
read -p " ╰─$ "  script
...
echo
echo $red
toilet -f future "Auto Deface 7" | lolcat
echo $cyan "Deface Masal Sebanyak 7 Web"
echo
echo $red"###"$yellow" ctrl + c to quit"$red" ###"
echo
echo
echo
echo "Masukan Script  Cukk!!!!"
echo $white "╭─"$green"Mr.venom"$cyan" ~/IndoDarknet"$white                               
read -p " ╰─$ " script
echo
echo
echo $white"Masukan Target1 !!!!"
echo $white "╭─"$green"Mr.venom"$cyan" ~/Gass"$white
read -p " ╰─$ " target1
...
echo $red"##########################$green" WELCOME "$red###########################"
echo $green"Author  : Awuu Zans /@Mr.Venom			"
echo $green"Gthub   : https://github.com/Defacer-DarkNet"
echo $red"Blog    : http://indonesiaanonymous.blogspot.com/2013/07/tool-deface-terbaru.html?m=1"
echo
echo $yellow"                          THANKS TO :"
echo
echo $cyan"[+] MR.404rgr  "
echo $cyan"[+] Mr.Unknwon "
echo $cyan"[+] Mr.Anonymous "
echo $cyan"[+] MR.Eror_X & All Member [I.D.N] "
echo $red"##########################$green" WELCOME "$red###########################"
...
if [ $apaan = "Q" ] || [ $apaan = "q" ]
then
echo " Terima kasih Kawan Sudah Menggunakan Tools ini :D "
exit
clear
fi
